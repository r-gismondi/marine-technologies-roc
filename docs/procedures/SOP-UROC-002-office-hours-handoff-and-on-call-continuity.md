# Standard Operating Procedure (SOP)-UROC-002 — Office-Hours Handoff and On-Call Continuity
...
Define how UROC maintains continuity for work that carries across normal office hours, planned absences, holidays, weekends, and after-hours periods covered by the company on-call schedule.

UROC does not operate as a shift-based department. This procedure replaces “shift handover” language with office-hours closeout, next-business-day review, and on-call escalation expectations.
...
- Carryover work that must be visible to another Agent, Senior Agent / Lead, or the UROC Supervisor.
...
| Senior Agent / Lead (if assigned) | Reviews carryover risk, supports prioritization, coordinates cross-stream handoffs, and confirms that important next actions are clear. |
...
2. **Separate routine carryover from urgent work.** Routine carryover stays in the official queue with a clear next-business-day action. Urgent work follows the escalation rules below and, where applicable, [SOP-UROC-001](SOP-UROC-001-incident-management-and-escalation.md).
...
4. **Notify the right role during office hours.** For work that needs same-day attention, notify the Senior Agent / Lead if assigned or the UROC Supervisor through the approved internal method.
5. **Prepare planned absence coverage.** Before planned time away, confirm coverage expectations with the UROC Supervisor and update open items with next action, owner, and timing.
...
Escalate to the UROC Supervisor during office hours when:
...
- The item may require incident handling under [SOP-UROC-001](SOP-UROC-001-incident-management-and-escalation.md).
...
If there is immediate danger, follow local emergency procedures first, then notify UROC through the appropriate company path.
