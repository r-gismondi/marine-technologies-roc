...
- **Agents** form a deliberately **generic** job family with **levels** (Junior → Senior, optional Lead). Work is organized by **streams** (support, Information Technology (IT) touchpoints, monitoring, remote operations support, data/shore pipeline) without multiplying parallel hierarchies prematurely—people grow **up** the ladder before the org grows **wide**.
...
| Information Technology (IT) (remote services) | Accounts, Virtual Private Network (VPN) / remote access logistics, tooling admin |
