...
Introduce when team size justifies a **technical/coaching lead** without creating a duplicate hierarchy.
...
Default progression: **Junior → Intermediate → Senior → (Lead)**. Expansion of headcount should prefer **level promotions** before adding parallel manager roles.
