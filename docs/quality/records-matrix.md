...
| Data access request | SOP-UROC-005 | Company access request or Information Technology (IT) service system | Information Technology / platform owner or data owner | Access-control record retention policy | Minimum necessary access; do not share credentials in records. |
