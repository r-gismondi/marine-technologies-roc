...
|-------------|-------------------|------------------|--------------|------------------|--------------|
| Incident ticket | SOP-UROC-001, SOP-UROC-006, SOP-UROC-007 | Company-approved ticketing / incident system | UROC Supervisor or assigned incident owner | Company incident / service record retention policy | Limit to response team and approved stakeholders. |
...
| Engineering / Maintenance handoff ticket | SOP-UROC-007 | Company-approved ticketing / work management system | UROC Supervisor until acceptance; then receiving Engineering or Maintenance owner | Service / operational record retention policy | Must document remote exhaustion or blockers, handoff package, and explicit receiving-owner acceptance. |
